...
<body style="background: #1a1d2e;">
	...
	<form name="formlogin" id="loginForm" class="formlogin mui-input-group form" method="post" action="<?php echo U('Login/checkLogin');?>">
		<div class="mui-input-row formdiv">
			...
			<input type="number" value="13888888888" name="account" style="margin-left:60px;position:absolute;top:-9px;" maxlength="11"  autocomplete="off" id="number" value="<?php echo ($account); ?>" class="forminput" placeholder="请输入手机号">
		</div>
		<div class="mui-input-row formdiv2">
			<img src="../Public/home/wap/images/mima.png" class="forddmimg2">
			<input type="password" value="123456" name="password" maxlength="32" class="forminput2" placeholder="请输入密码">
		</div>
